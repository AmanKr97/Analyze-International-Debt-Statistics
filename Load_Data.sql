...
load data local infile 'H:/jupyternotebook/project/Analyze-International-Debt-Statistics/Dataset/IDS_ALLCountries_Data.csv'
...
load data local infile 'H:/jupyternotebook/project/Analyze-International-Debt-Statistics/Dataset/IDS_SeriesMetaData.csv'
